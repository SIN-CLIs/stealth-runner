...
# ruff: noqa: E501
# Captcha solver prompts contain long natural-language strings for NIM models;
# wrapping them would change the prompt token boundaries.
...
class BrowserCaptchaIntegration:
    ...
    async def _solve_slider_captcha(self, browser_driver) -> CaptchaResult:
        ...
        await browser_driver.find_element(".slider-bg, .captcha-bg")
        await browser_driver.find_element(".slider-piece, .captcha-slider")
