...
# Dadurch werden `survey.network.*` Imports auflösbar.
...
def test_load_from_env_returns_correct_length(sample_proxies_json):
    ...
    from survey.network.proxy_pool import ProxyPool
...
def test_record_outcome_success_increases_score():
    ...
    with patch("survey.network.proxy_pool.persist_event"):
...
def test_score_clamping_min_max():
    ...
    from survey.network.proxy_pool import ProxyEntry
...
def test_jsonl_persistence_format(temp_log_dir):
    ...
    from survey.network.proxy_pool import ProxyEntry
    from survey.network import ip_quality
...
def test_ip_quality_score_function():
    ...
    from survey.network.ip_quality import score
...
def test_is_cold_threshold():
    ...
    from survey.network.ip_quality import is_cold
