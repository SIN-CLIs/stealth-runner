...
class TestProviderDetection(unittest.TestCase):
    ...
    def test_detect_qualtrics(self):
        ...
        self.assertEqual(
            _detect_provider("https://survey.qualtrics.com/jfe/form/SV_abc123"), "qualtrics"
        )

    def test_detect_toluna(self):
        from tools.tool_open_survey import _detect_provider

        self.assertEqual(_detect_provider("https://tolunastart.com/survey/abc"), "toluna")

    def test_detect_cint(self):
        from tools.tool_open_survey import _detect_provider

        self.assertEqual(_detect_provider("https://s.cint.com/Survey/Fingerprint?sid=123"), "cint")
    ...
    def test_detect_nfield(self):
        ...
        self.assertEqual(
            _detect_provider("https://nfieldeu-interviewing.nfieldmr.com/welcome"), "nfield"
        )

    def test_detect_strat7(self):
        from tools.tool_open_survey import _detect_provider

        self.assertEqual(_detect_provider("https://survey.strat7.com/s/abc"), "strat7")

    def test_detect_unknown(self):
        from tools.tool_open_survey import _detect_provider

        self.assertEqual(_detect_provider("https://example.com/something"), "unknown")

    def test_detect_purespectrum(self):
        from tools.tool_open_survey import _detect_provider

        self.assertEqual(_detect_provider("https://purespectrum.com/survey/abc"), "purespectrum")

    def test_detect_case_insensitive(self):
        from tools.tool_open_survey import _detect_provider

        self.assertEqual(_detect_provider("https://QUAlTRICS.com/form"), "qualtrics")
