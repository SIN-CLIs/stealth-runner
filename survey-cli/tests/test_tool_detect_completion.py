...
class TestDetectCompletion(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._ws_patcher = patch(
            "tools.tool_detect_completion.websocket.create_connection"
        )
    ...
    def test_detect_dashboard_redirect(self):
        ...
        self._set_response(
            url="https://app.prolific.co/submissions/complete?cc=xyz",
            title="prolific",
            text=""
        )
        from tools.tool_detect_completion import detect
    ...
    def test_detect_url_complete_keyword(self):
        ...
        self._set_response(
            url="https://example.com/survey/complete?id=123",
            title="",
            text="danke"
        )
        from tools.tool_detect_completion import detect
