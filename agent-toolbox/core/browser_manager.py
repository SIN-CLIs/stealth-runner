...
class BrowserManager:
    ...
    def __init__(
        ...
        self.chrome_path = (
            chrome_path or "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome"
        )
    ...
    async def _wait_for_cdp(self, max_retries: int = 15):
        ...
        for i in range(max_retries):
            try:
                ...
                urllib.request.urlopen(f"http://127.0.0.1:{self.cdp_port}/json/version", timeout=2)
