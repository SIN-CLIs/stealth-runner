...
def _select_best_survey(
    surveys: list[DashboardSurvey], strategy: str, min_reward: float
) -> DashboardSurvey | None:
    """
...
"""
    ...
    clicked = click_result and "clicked" in (
        click_result.get("value", "") if isinstance(click_result, dict) else ""
    )
