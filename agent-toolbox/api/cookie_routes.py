...
async def extract_cookies(request: CookieExtractRequest):
    ...
    if not browser_mgr.is_running:
        ...
        raise HTTPException(
            status_code=400, detail="Browser nicht gestartet. Rufe POST /browser/start auf."
        )
    ...
    try:
        ...
        cookies = await cookie_mgr.extract_cookies(page, domain_filter=request.domain_filter)
